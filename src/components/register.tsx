...
export default function RegistersComponent() {
    const notify = (messsage: string) => toast(messsage);
        ...
        <div className="h-screen md:grid md:grid-cols-2">
            <div
                ...
                <div className="py-10 md:py-0">
                    ...
                    <p className="text-white mt-1 text-center md:text-left">The Gateway to The Blockchain</p>
                    <Link href={'/'}>
            ...
            <div className="mx-auto md:w-1/2 justify-center py-10 items-center bg-white px-2 md:px-0">
                <form className="bg-white" onSubmit={handleSubmit}>
                    <h1 className="text-gray-800 font-bold text-2xl mb-1 text-center md:text-left">Hello There!</h1>
                    <p className="text-sm font-normal text-gray-600 mb-7 text-center md:text-left">Welcome</p>
                    ...
                    <Link href={"login"} className="md:text-sm text-xs ml-2">Dont have An Account ?</Link>
                </form>
            </div>
        </div>
        <ToastContainer />
